...
### ✏️ 김승욱
>백엔드: 자바 - 스프링부트 기반의 백엔드 동작 개념에 대한 지식과 이해도를 축적하는 시간이었습니다. 한국에서 실질적으로 가장 많이 사용되는 프레임워크인 스프링 부트에 대해 배울 수 있는 시간이었고, 차후 어떻게 지식과 경험을 쌓아가야 하는지 방향을 정할 수 있게 되었습니다.
>프론트엔드: 사용자가 어떤 화면을 마주해야 편안하게 느끼는가에 대한 고민을 할 수 있어 의미있는 시간이었습니다. 사용자가 보는 화면을 구성하는데 활용되는 여러 툴과 HTML - CSS - JavaScript로 이어지는 프론트엔드 개발 도구, 그리고 프레임워크인 Vue.js 작동 원리에 대해 공부했고, AI가 발달하더라도 결국 서비스를 활용하는 인간에 대한 이해가 가장 중요하다는 것을 배웠습니다.
